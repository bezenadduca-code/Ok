    ...
    pcall(function()
        ...
        conn = svc.Run.RenderStepped:Connect(function(dt)
            pcall(function()
                ...
                -- Camera placed near the killer, looking back at the player
                -- Result: killer's front is visible, player faces killer, no back-of-head shot
                local camPos   = killerPos - (dir * 3) + Vector3.new(0, 2, 0)
                local targetCF = CFrame.lookAt(camPos, playerPos + Vector3.new(0, 2, 0))
